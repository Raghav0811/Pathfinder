import { getShortestPathNodes } from "../helpers/djikstraHelpers";
...
export default function visualizeDepthFirst(
  grid,
  startNode,
  finishNode,
  interNode,
  ...
  const firstVisitedNodesInOrder = interNode
    ? depthFirst(firstGrid, startNodeObj, firstInterNodeObj)
    : depthFirst(firstGrid, startNodeObj, finishNodeObj);
  const secondVisitedNodesInOrder = interNode
    ? depthFirst(secondGrid, secondInterNodeObj, finishNodeObj)
    : null;
